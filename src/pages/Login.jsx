      ...
      <Container maxW={'7xl'} py={"50px"}>
        <Stack
          ...
          <Stack flex={1} spacing={{ base: 5, md: 10 }} >
            ...
            <Input boxShadow={'rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;'} focusBorderColor='gray.400' placeholder='Enter your email' h={"4em"} w={'70%'} borderRadius={'40px'} outline={'none'}/>
            <Button zIndex={3} top={0} right={'18%'} position={'absolute'} colorScheme={'blue'} w={'120px'} h={'100%'} borderRadius={'40px'}>Login</Button>
            </Box>
            <Box color={'#476788'}>
